...
public class Function {
    ...
    */
	 ...
	 * @param id:文章记录唯一主键
	 * @return 数据库查询，新闻详情字符串结果集 Created by 明日科技 on 16/8/22.
	 * @throws SQLException
	 */
	 ...
	 * @param toPage:分页跳转页面地址，pageNum:每页显示记录数量
	 * @return 数据库查询，公告列表字符串结果集 Created by 明日科技 on 16/8/22.
	 * @throws SQLException
	 */
	 ...
	 * @param id:文章记录唯一主键
	 * @return 数据库查询，新闻公告字符串结果集 Created by 明日科技 on 16/8/22.
	 * @throws SQLException
	 */
